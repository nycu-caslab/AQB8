...
namespace bvh
{
    ...
    struct NodeIntersector
    {
        ...
        bvh_always_inline
            Scalar
            intersect_axis(int axis, Scalar p, const Ray<Scalar> &ray) const
        {
        ...
        bvh_always_inline
            ...
            intersect(const float *bounds, const Ray<Scalar> &ray) const
        {
    ...
    struct FastNodeIntersector : public NodeIntersector<Bvh, FastNodeIntersector<Bvh>>
    {
        ...
        bvh_always_inline
            Scalar
            intersect_axis(int axis, Scalar p, const Ray<Scalar> &) const
        {
